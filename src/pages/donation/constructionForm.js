...
const ConstructionForm = React.memo(
  ({
    form,
    uiRefresh,
    alertRef,
    ...
    const saveConstruction = () => {
      ...
      (async () => {
        ...
        if (res.isError) {
          ...
          ToastMessage({
            type: 'success',
            message: 'Constructions Details added succesfully!',
            timeout: 1200,
          });
        }
      })();
          ...
          <div className="pt-5 pb-3">
            ...
            <div className="flex w-full justify-start items-center relative">
                ...
                <InputSelect
                    ...
                    formKey="constructionType"
                    ID="constructionType"
                    formRef={formRef}
                    uiRefresh={ui}
                    label="Type of Construction"
                    placeholder="--Select--"
                    options={formList.constructionType}
              ...
              <div className="flex w-full justify-start items-center mt-3">
                <div className="flex flex-col w-full">
                  ...
                  <textarea
                    className={`w-full rounded border ${
                      !formRef.current.constructComments
                        ? 'border-red-500 err-input'
                        : 'border-gray-400'
                    }`}
                    value={formRef.current.constructComments}
