...
const GeneralForm = React.memo(
  ({ form, uiRefresh, alertRef, pageData, recordIndex, generalAddedList }) => {
    const [ui] = useState(-1);
    ...
    const saveGeneral = () => {
      ...
      (async () => {
        ...
        if (res.isError) {
          ...
          ToastMessage({
            type: 'success',
            message: 'General Deatails added succesfully!',
            timeout: 1200,
          });
        }
      })();
    ...
    const openFileUpload = () => {
      if (typeof formRef.current.saved !== 'undefined') {
        ToastMessage({
          type: 'error',
          message: 'Save the general and upload!',
          timeout: 1200,
        });
        return;
      }
    ...
    const removeGeneral = () => {
      if (generalAddedList.current[recordIndex].saved === false) {
        alertRef.current.showConfirm(
          ...
          'Confirm?',
          'Are you sure to delete this general?'
        );
      } else {
        alertRef.current.showConfirm(
          (res) => {
              ...
              <div className="flex w-full justify-start items-center mt-3">
                ...
                <div className="w-1/3 mr-5">
                  <GroupInput
                    ...
                    formRef={formRef}
                    uiRefresh={ui}
                    label="Current Age Of Year"
                    placeholder="Current Age Of Year"
                    required="Current Age Of Year is required"
                  />
                </div>
                <div className="w-1/3 mr-5">
                  <InputSelect
              ...
              <div className="flex w-full justify-start items-center mt-3">
                ...
                <div className="w-1/3 mr-5">
                  <InputRadio
                    ...
                    values={['Single', 'Married']}
                    required="Single /Married  is required"
                  />
                </div>
              </div>
              <div className="flex w-full justify-start items-center mt-3">
                <div className="flex w-full mr-5">
                  <InputRadio
                    ...
                    ui={ui}
                    name="isDependent"
                    label="Can some one claim you as dependent?"
                    values={['Yes', 'No']}
                    required="Yes /No  is required"
                  />
                </div>
