...
const EducationForm = React.memo(
  ({
    ...
    const completeHandler = (event) => {
      educationAddedList.current[recordIndex].documents.push({
    ...
    const saveEducation = () => {
        ...
        : [
            {
              _modal: 'TaxList',
              _condition: 'update',
              _find: { _id: pageData.current._id, 'education.id': arr.id },
              _data: { $set: { 'education.$': arr } },
      ...
      (async () => {
        ...
        if (res.isError) {
          ...
          ToastMessage({
            type: 'success',
            message: 'Education Deatails added succesfully!',
            timeout: 1200,
          });
        }
      })();
    ...
    const openFileUpload = () => {
      if (typeof formRef.current.saved !== 'undefined') {
        ToastMessage({
          type: 'error',
          message: 'Save the education details and upload!',
          timeout: 1200,
        });
        return;
      }
            ...
            let params = [
              {
                ...
                _condition: 'update',
                _find: { _id: pageData.current._id },
                _data: { $pull: { education: { id: formRef.current.id } } },
              },
            ];
          ...
          <div className="pt-5 pb-3">
            <form>
              <div className="flex w-full justify-center  items-center relative">
                <h1>
                  If you or your child attending the first four years of
                  college?
                </h1>
              </div>
              <div className="flex w-full justify-center items-center relative">
                <div className="px-2">
                  <InputRadio
                    ...
                    ui={ui}
                    name="childAttend"
                    label="Are you or your child attending the first four years of college?"
                    values={['yes', 'No']}
              ...
              <div className="flex w-full justify-start items-center relative">
                <div className="w-1/2 mr-5">
                  <GroupInput
                    ...
                    formRef={formRef}
                    uiRefresh={ui}
                    placeholder="Tution and fees Paid"
                  />
                </div>
                <div className="w-1/2 mr-5">
                  <GroupInput
                    styleClass="flex flex-col mb-4"
                    formKey="tutionAmount"
                    formRef={formRef}
                    uiRefresh={ui}
                    placeholder="$0.00"
                    required="Enter Tution and fees Paid"
                  />
                </div>
              </div>
              <div className="flex w-full justify-start items-center relative">
                ...
                <div className="w-1/2 mr-5">
                  <GroupInput
                    styleClass="flex flex-col mb-4"
                    formKey="stuloanAmount"
                    formRef={formRef}
                    uiRefresh={ui}
                    placeholder="$0.00"
                    required="Enter Student loan interest paid"
                  />
                </div>
              </div>
                ...
                <div className="flex flex-col w-full">
                  ...
                  <textarea
                    className={`w-full rounded border ${
                      !formRef.current.educationComments
                    ...
                    onChange={(e) => {
                      formRef.current.educationComments = e.currentTarget.value;
                      subRefresh(Date.now());
                    }}
                    rows={4}
                  ></textarea>
