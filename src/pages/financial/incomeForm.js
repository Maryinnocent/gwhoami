  ...
  ({
    ...
    const saveIncome = () => {
      ...
      (async () => {
        ...
        if (res.isError) {
          ...
          ToastMessage({
            type: 'success',
            message: 'Income Details added succesfully!',
            timeout: 1200,
          });
        }
      })();
    ...
    const openFileUpload = () => {
      if (typeof formRef.current.saved !== 'undefined') {
        ToastMessage({
          type: 'error',
          message: 'Save the Income Details and upload!',
          timeout: 1200,
        });
        return;
      }
          ...
          <div className="pt-5 pb-3">
            ...
            <div className="w-1/3 mr-5">
                ...
                <div className="w-1/3 mr-5">
                  <GroupInput
                    styleClass="flex flex-col mb-4"
                    formKey="profitIncome"
                    formRef={formRef}
                    uiRefresh={ui}
                    label="Profit Income"
                    placeholder="Profit Income"
                    required="Profit Income is required"
                    icon={faUser}
                  />
                </div>
                <div className="w-1/3 mr-5">
                  ...
                  <GroupInput
                    styleClass="flex flex-col mb-4"
                    formKey="dividedIncome"
                    formRef={formRef}
                    uiRefresh={ui}
                    label="Divided Income"
                    placeholder="Divided Income"
                    required="Divided Income is required"
                    icon={faUser}
                  />
                </div>
                <div className="w-1/3 mr-5">
                ...
                <div className="w-1/3 mr-5">
                  <GroupInput
                    styleClass="flex flex-col mb-4"
                    formKey="capitalIncome"
                    formRef={formRef}
                    uiRefresh={ui}
                    label="Capital Income"
                    placeholder="Capital Income"
                    required="Capital Income is required"
                    icon={faUser}
                  />
                </div>     
                        </div>
                  ...
                  <GroupInput
                    styleClass="flex flex-col mb-4"
                    formKey="royaltyIncome"
                    formRef={formRef}
                    uiRefresh={ui}
                    label="Royalty Income"
                    placeholder="Royalty Income"
                    required="Royalty Income is required"
                    icon={faUser}
                  />
                </div>   
                <div className="w-1/3 mr-5">
                ...
                <div className="w-1/3 mr-5">
                  ...
                  <InputRadio
                    ...
                    ui={ui}
                    name="optCurrentyear"
                    label="Is this Current Month income?"
                    values={['Yes', 'No']}
