...
const SportsForm = React.memo(
  ({
    ...
    const completeHandler = (event) => {
        sportsAddedList.current[recordIndex].documents.push({
    ...
    const saveSports = () => {
        ...
        : [
            {
              _modal: 'CrimeList',
              _condition: 'update',
              _find: { _id: pageData.current._id, 'sports.id': arr.id },
              _data: { $set: { 'sports.$': arr } },
      ...
      (async () => {
        ...
        if (res.isError) {
          ...
          ToastMessage({
            type: 'success',
            message: 'Sports Crime Details added succesfully!',
            timeout: 1200,
          });
        }
      })();
    ...
    const openFileUpload = () => {
      if (typeof formRef.current.saved !== 'undefined') {
        ToastMessage({
          type: 'error',
          message: 'Save the Sports Crime Details and upload!',
          timeout: 1200,
        });
        return;
      }
    ...
    const removeSports = () => {
      if (sportsAddedList.current[recordIndex].saved === false) {
        alertRef.current.showConfirm(
          ...
          'Confirm?',
          'Are you sure to delete this Sports Crime Details?'
        );
      } else {
        alertRef.current.showConfirm(
          (res) => {
            ...
            let params = [
              {
                ...
                _condition: 'update',
                _find: { _id: pageData.current._id },
                _data: { $pull: { sports: { id: formRef.current.id } } },
              },
            ];
          ...
          'Confirm?',
          'Are you sure to delete this Sports Crime Save Details?'
        );
      }
    };
    return (
        ...
        <div className="p-5 border rounded shadow-md relative" ref={currentDom}>
          ...
          <div className="pt-5 pb-3">
            ...
            <div className="flex w-full justify-start items-center mt-3">
                ...
                <InputSelect
                    styleClass="flex flex-col mb-4"
                    formKey="gameCategory"
                    ID="gameCategory"
                    formRef={formRef}
                    uiRefresh={ui}
                    label="Game Category"
                    placeholder="--Select--"
                    options={formList.gameCategory}
             ...
             <div className="w-1/3 mr-5">
                ...
                <GroupInput
                    styleClass="flex flex-col mb-4"
                    formKey="sportsLocation"
                    formRef={formRef}
                    uiRefresh={ui}
                    label="Location (Sports Campus)"
                    placeholder="Location (Sports Campus)"
                    required="Location (Sports Campus) is required"
                    icon={faUser}
                  />
                </div>  
                </div>
             ...
             <div className="w-1/3 mr-5">
                ...
                <div className="w-1/3 mr-5">
                  <InputRadio
                    styleClass="flex flex-col mb-4"
                    formKey="isAccidentally"
                    formRef={formRef}
                    ui={ui}
                    name="isAccidentally"
                    label="Is the accidently or purposefully?"
                    values={['Yes', 'No']}
                  ...
                  <InputRadio
                    ...
                    ui={ui}
                    name="isRetry"
                    label="Did you mensioned to retry?"
                    values={['Yes', 'No']}
                    required="Yes /No  is required"
                  />
                  </div>
                  ...
                  <InputRadio
                    ...
                    ui={ui}
                    name="isOpponent"
                    label="Is this involved opponent team?"
                    values={['Yes', 'No']}
                    required="Yes /No  is required"
                  />
                ...
                <div className="w-1/3 mr-5">
                  <InputRadio
                    ...
                    ui={ui}
                    name="isAnyCard"
                    label="Did you get any wild or red card?"
                    values={['Yes', 'No']}
                    required="Yes /No  is required"
                  />
                  </div>
                  ...
                  <GroupInput
                    ...
                    uiRefresh={ui}
                    label="Retry Name"
                    placeholder="Retry Name"
                    required="Retry Name is required"
                    icon={faUser}
                  />
              ...
              <div className="flex w-full justify-start items-center mt-3">
                  ...
                  <GroupInput
                    styleClass="flex flex-col mb-4"
                    formKey="numberOfCard"
                    formRef={formRef}
                    uiRefresh={ui}
                    label="Number Of Wild / Red card #"
                    placeholder="Number Of Wild / Red card #"
                    required="Number Of Wild / Red card # is required"
                    icon={faUser}
                  />
                </div>
                <div className="w-1/3 mr-5">
