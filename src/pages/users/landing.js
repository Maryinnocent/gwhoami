        ...
        <>
            <div className="flex flex-col px-6 w-full container mx-auto pb-5">
                ...
                <div className="flex flex-wrap w-full h-full mt-5 gap-x-20 gap-y-20">
                    <div className="w-56 h-40 bg-blue-700 rounded-xl flex justify-center items-center text-gray-200 homeboxshadow cursor-pointer" onClick={showProfile}>Name:{MyLocalStorage.getLoginInfo().firstName} {MyLocalStorage.getLoginInfo().lastName} 'S Profile</div>
