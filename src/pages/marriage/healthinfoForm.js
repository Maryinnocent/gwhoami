...
const HealthinfoForm = React.memo(
  ({
    form,
    uiRefresh,
    alertRef,
    ...
    const completeHandler = (event) => {
      healthinfoAddedList.current[recordIndex].documents.push({
    ...
    const saveHealthinfo = () => {
        ...
        : [
            {
              _modal: 'MarriageList',
              _condition: 'update',
              _find: { _id: pageData.current._id, 'healthinfo.id': arr.id },
              _data: { $set: { 'healthinfo.$': arr } },
      ...
      (async () => {
        ...
        if (res.isError) {
          ...
          ToastMessage({
            type: 'success',
            message: 'Health-Info Saving Details added succesfully!',
            timeout: 1200,
          });
        }
      })();
    ...
    const removeHealthinfo = () => {
      if (healthinfoAddedList.current[recordIndex].saved === false) {
        alertRef.current.showConfirm(
          ...
          'Confirm?',
          'Are you sure to delete this Health Info Save Details?'
        );
      } else {
        alertRef.current.showConfirm(
          (res) => {
            ...
            let params = [
              {
                ...
                _condition: 'update',
                _find: { _id: pageData.current._id },
                _data: { $pull: { healthinfo: { id: formRef.current.id } } },
              },
            ];
          ...
          'Confirm?',
          'Are you sure to delete this Health Info Details?'
        );
      }
    };
    return (
            ...
            <div className="flex w-full justify-start items-center relative">
                <div className="w-1/3 mr-5">
                  <InputRadio
                    ...
                    ui={ui}
                    name="handicape"
                    label="Do have any physically handicaps?"
                    values={['Yes', 'No']}
              ...
              <div className="flex w-full justify-start items-center relative">
                <div className="w-1/3 mr-5">
                  <InputRadio
                    styleClass="flex flex-col mb-4"
                    formKey="vaccinations"
                    formRef={formRef}
                    ui={ui}
                    name="vaccinations"
                    label="Did you complete all your vaccinations?"
                    values={['Yes', 'No']}
                    required="Yes /No  is required"
                  />
                </div>
                ...
                <GroupInput
                    ...
                    formRef={formRef}
                    uiRefresh={ui}
                    label="Please specify if any missing"
                    placeholder="Please specify if any missing"
                    icon={faUser}
                  />
                </div>
              </div>
              <div className="flex w-full justify-start items-center relative">
                ...
                <DatePicker
                    ...
                    formRef={formRef}
                    uiRefresh={ui}
                    label="Covid Vaccine Date"
                    placeholder="Covid Vaccine Date"
                    required="Covid Vaccine Date is required"
              ...
              <div className="flex w-full justify-start items-center relative">
                <div className="w-1/3 mr-5">
                  <InputRadio
                    ...
                    ui={ui}
                    name="allCovid"
                    label="Have you vaccinated all the COVID injections?"
                    values={['Yes', 'No']}
                    required="Yes /No  is required"
                  />
                </div>
                ...
                <div className="flex flex-col w-full">
                  ...
                  <textarea
                    className={`w-full rounded border ${
                      !formRef.current.healthinfoComments
